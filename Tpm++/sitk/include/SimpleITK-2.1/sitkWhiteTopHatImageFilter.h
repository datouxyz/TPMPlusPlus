...
*
*=========================================================================*/
#ifndef sitkWhiteTopHatImageFilter_h
#define sitkWhiteTopHatImageFilter_h
...
\sa itk::simple::WhiteTopHat for the procedural interface
\sa itk::WhiteTopHatImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT WhiteTopHatImageFilter : public ImageFilter {
    public:
      using Self = WhiteTopHatImageFilter;

      /** Destructor */
      virtual ~WhiteTopHatImageFilter();
...
\
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("WhiteTopHatImageFilter"); }
     ...
     *
     * \sa itk::simple::WhiteTopHatImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image WhiteTopHat ( const Image& image1, std::vector<unsigned int> kernelRadius = std::vector<uint32_t>(3, 1), KernelEnum kernelType = itk::simple::sitkBall, bool safeBorder = true );
