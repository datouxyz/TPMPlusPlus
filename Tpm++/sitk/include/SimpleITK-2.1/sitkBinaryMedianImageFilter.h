...
*
*=========================================================================*/
#ifndef sitkBinaryMedianImageFilter_h
#define sitkBinaryMedianImageFilter_h
...
\sa itk::simple::BinaryMedian for the procedural interface
\sa itk::BinaryMedianImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT BinaryMedianImageFilter : public ImageFilter {
    public:
...
\
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("BinaryMedianImageFilter"); }
     ...
     * \brief Applies a version of the median filter optimized for binary images.
     *
     * This function directly calls the execute method of BinaryMedianImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::BinaryMedianImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image BinaryMedian ( const Image& image1, std::vector<unsigned int> radius = std::vector<unsigned int>(3, 1), double foregroundValue = 1.0, double backgroundValue = 0.0 );
