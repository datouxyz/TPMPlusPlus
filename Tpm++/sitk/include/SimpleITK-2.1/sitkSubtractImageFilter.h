...
*
*=========================================================================*/
#ifndef sitkSubtractImageFilter_h
#define sitkSubtractImageFilter_h
...
\sa itk::simple::Subtract for the procedural interface
\sa itk::SubtractImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT SubtractImageFilter : public ImageFilter {
    public:
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("SubtractImageFilter"); }
     ...
     * \brief Pixel-wise subtraction of two images.
     *
     * This function directly calls the execute method of SubtractImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::SubtractImageFilter for the object oriented interface
     * @{
     */
#ifndef SWIG
     SITKBasicFilters_EXPORT Image Subtract ( Image&& image1, const Image& image2 );
#endif
     SITKBasicFilters_EXPORT Image Subtract ( const Image& image1, const Image& image2 );

     /** @} */
     SITKBasicFilters_EXPORT Image Subtract ( const Image& image1, double constant );
#ifndef  SWIG
     SITKBasicFilters_EXPORT Image Subtract ( Image&& image1, double constant );
#endif
     SITKBasicFilters_EXPORT Image Subtract ( double constant, const Image& image2 );
  }
}
#endif
