...
*
*=========================================================================*/
#ifndef sitkShanbhagThresholdImageFilter_h
#define sitkShanbhagThresholdImageFilter_h
...
\sa itk::simple::ShanbhagThreshold for the procedural interface
\sa itk::ShanbhagThresholdImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT ShanbhagThresholdImageFilter : public ImageFilter {
    public:
      using Self = ShanbhagThresholdImageFilter;

      /** Destructor */
      virtual ~ShanbhagThresholdImageFilter();
...
\
     ...
     double GetThreshold() const { return this->m_Threshold; };
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("ShanbhagThresholdImageFilter"); }
     ...
     * \brief Threshold an image using the Shanbhag Threshold.
     *
     * This function directly calls the execute method of ShanbhagThresholdImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::ShanbhagThresholdImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image ShanbhagThreshold ( const Image & image, const Image & maskImage, uint8_t insideValue = 1u, uint8_t outsideValue = 0u, uint32_t numberOfHistogramBins = 256u, bool maskOutput = true, uint8_t maskValue = 255u );
     SITKBasicFilters_EXPORT Image ShanbhagThreshold ( const Image & image, uint8_t insideValue = 1u, uint8_t outsideValue = 0u, uint32_t numberOfHistogramBins = 256u, bool maskOutput = true, uint8_t maskValue = 255u );
     /** @} */
  }
}
#endif
