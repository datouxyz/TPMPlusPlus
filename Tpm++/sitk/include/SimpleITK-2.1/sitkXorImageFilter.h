...
*
*=========================================================================*/
#ifndef sitkXorImageFilter_h
#define sitkXorImageFilter_h
...
\sa itk::simple::Xor for the procedural interface
\sa itk::XorImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT XorImageFilter : public ImageFilter {
    public:
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("XorImageFilter"); }
     ...
     * \brief Computes the XOR bitwise operator pixel-wise between two images.
     *
     * This function directly calls the execute method of XorImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::XorImageFilter for the object oriented interface
     * @{
     */
#ifndef SWIG
     SITKBasicFilters_EXPORT Image Xor ( Image&& image1, const Image& image2 );
#endif
     SITKBasicFilters_EXPORT Image Xor ( const Image& image1, const Image& image2 );

     /** @} */
     SITKBasicFilters_EXPORT Image Xor ( const Image& image1, int constant );
#ifndef  SWIG
     SITKBasicFilters_EXPORT Image Xor ( Image&& image1, int constant );
#endif
     SITKBasicFilters_EXPORT Image Xor ( int constant, const Image& image2 );
  }
}
#endif
