...
*
*=========================================================================*/
#ifndef sitkDiffeomorphicDemonsRegistrationFilter_h
#define sitkDiffeomorphicDemonsRegistrationFilter_h
...
\sa itk::DiffeomorphicDemonsRegistrationFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT DiffeomorphicDemonsRegistrationFilter : public ImageFilter {
    public:
...
\
       ...
       */
      SITK_RETURN_SELF_TYPE_HEADER SetUseFirstOrderExp ( bool UseFirstOrderExp ) { this->m_UseFirstOrderExp = UseFirstOrderExp; return *this; }

      /** Set the value of UseFirstOrderExp to true or false respectfully. */
      SITK_RETURN_SELF_TYPE_HEADER UseFirstOrderExpOn() { return this->SetUseFirstOrderExp(true); }
      SITK_RETURN_SELF_TYPE_HEADER UseFirstOrderExpOff() { return this->SetUseFirstOrderExp(false); }

      /**
       * Use a first-order approximation of the exponential. This amounts to using an update rule of the type s <- s o (Id + u) instead of s <- s o exp(u)
       */
      bool GetUseFirstOrderExp() const { return this->m_UseFirstOrderExp; }\
     ...
     double GetMetric() const { return this->m_pfGetMetric(); };
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("DiffeomorphicDemonsRegistrationFilter"); }
