...
*
*=========================================================================*/
#ifndef sitkMagnitudeAndPhaseToComplexImageFilter_h
#define sitkMagnitudeAndPhaseToComplexImageFilter_h
...
\brief Implements pixel-wise conversion of magnitude and phase data into complex voxels.
...
\sa itk::simple::MagnitudeAndPhaseToComplex for the procedural interface
\sa itk::MagnitudeAndPhaseToComplexImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT MagnitudeAndPhaseToComplexImageFilter : public ImageFilter {
    public:
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("MagnitudeAndPhaseToComplexImageFilter"); }
     ...
     * \brief Implements pixel-wise conversion of magnitude and phase data into complex voxels.
     *
     * This function directly calls the execute method of MagnitudeAndPhaseToComplexImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::MagnitudeAndPhaseToComplexImageFilter for the object oriented interface
     * @{
     */
#ifndef SWIG
     SITKBasicFilters_EXPORT Image MagnitudeAndPhaseToComplex ( Image&& image1, const Image& image2 );
#endif
     SITKBasicFilters_EXPORT Image MagnitudeAndPhaseToComplex ( const Image& image1, const Image& image2 );

     /** @} */
     SITKBasicFilters_EXPORT Image MagnitudeAndPhaseToComplex ( const Image& image1, double constant );
#ifndef  SWIG
     SITKBasicFilters_EXPORT Image MagnitudeAndPhaseToComplex ( Image&& image1, double constant );
#endif
     SITKBasicFilters_EXPORT Image MagnitudeAndPhaseToComplex ( double constant, const Image& image2 );
  }
}
#endif
