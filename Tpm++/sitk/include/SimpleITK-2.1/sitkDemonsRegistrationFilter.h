...
*
*=========================================================================*/
#ifndef sitkDemonsRegistrationFilter_h
#define sitkDemonsRegistrationFilter_h
...
\sa itk::DemonsRegistrationFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT DemonsRegistrationFilter : public ImageFilter {
    public:
...
\
       ...
       */
      SITK_RETURN_SELF_TYPE_HEADER SetUseMovingImageGradient ( bool UseMovingImageGradient ) { this->m_UseMovingImageGradient = UseMovingImageGradient; return *this; }

      /** Set the value of UseMovingImageGradient to true or false respectfully. */
      SITK_RETURN_SELF_TYPE_HEADER UseMovingImageGradientOn() { return this->SetUseMovingImageGradient(true); }
      SITK_RETURN_SELF_TYPE_HEADER UseMovingImageGradientOff() { return this->SetUseMovingImageGradient(false); }

      /**
       * Switch between using the fixed image and moving image gradient for computing the displacement field updates.
       */
      bool GetUseMovingImageGradient() const { return this->m_UseMovingImageGradient; }\
     ...
     double GetMetric() const { return this->m_pfGetMetric(); };
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("DemonsRegistrationFilter"); }
    ...
    private:
      ...
      bool  m_UseMovingImageGradient{false};
