...
*
*=========================================================================*/
#ifndef sitkMorphologicalGradientImageFilter_h
#define sitkMorphologicalGradientImageFilter_h
...
\sa itk::simple::MorphologicalGradient for the procedural interface
\sa itk::MorphologicalGradientImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT MorphologicalGradientImageFilter : public ImageFilter {
    public:
      using Self = MorphologicalGradientImageFilter;

      /** Destructor */
      virtual ~MorphologicalGradientImageFilter();
...
\
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("MorphologicalGradientImageFilter"); }
     ...
     * \brief gray scale dilation of an image
     *
     * This function directly calls the execute method of MorphologicalGradientImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::MorphologicalGradientImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image MorphologicalGradient ( const Image& image1, std::vector<unsigned int> kernelRadius = std::vector<uint32_t>(3, 1), KernelEnum kernelType = itk::simple::sitkBall );
