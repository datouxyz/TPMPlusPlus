...
*
*=========================================================================*/
#ifndef sitkGrayscaleGeodesicErodeImageFilter_h
#define sitkGrayscaleGeodesicErodeImageFilter_h
...
\sa itk::simple::GrayscaleGeodesicErode for the procedural interface
\sa itk::GrayscaleGeodesicErodeImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT GrayscaleGeodesicErodeImageFilter : public ImageFilter {
    public:
      using Self = GrayscaleGeodesicErodeImageFilter;

      /** Destructor */
      virtual ~GrayscaleGeodesicErodeImageFilter();
...
\
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("GrayscaleGeodesicErodeImageFilter"); }
     ...
     * \brief geodesic gray scale erosion of an image
     *
     * This function directly calls the execute method of GrayscaleGeodesicErodeImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::GrayscaleGeodesicErodeImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image GrayscaleGeodesicErode ( const Image& image1, const Image& image2, bool runOneIteration = false, bool fullyConnected = false );
