...
*
*=========================================================================*/
#ifndef sitkLessImageFilter_h
#define sitkLessImageFilter_h
...
\sa itk::simple::Less for the procedural interface
\sa itk::BinaryFunctorImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT LessImageFilter : public ImageFilter {
    public:
      using Self = LessImageFilter;
...
\
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("LessImageFilter"); }
     ...
     * \brief Implements pixel-wise generic operation of two images, or of an image and a constant.
     *
     * This function directly calls the execute method of LessImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::LessImageFilter for the object oriented interface
     * @{
     */
#ifndef SWIG
     SITKBasicFilters_EXPORT Image Less ( Image&& image1, const Image& image2, uint8_t backgroundValue = 0u, uint8_t foregroundValue = 1u );
#endif
     SITKBasicFilters_EXPORT Image Less ( const Image& image1, const Image& image2, uint8_t backgroundValue = 0u, uint8_t foregroundValue = 1u );

     /** @} */
     SITKBasicFilters_EXPORT Image Less ( const Image& image1, double constant, uint8_t backgroundValue = 0u, uint8_t foregroundValue = 1u );
#ifndef  SWIG
     SITKBasicFilters_EXPORT Image Less ( Image&& image1, double constant, uint8_t backgroundValue = 0u, uint8_t foregroundValue = 1u );
#endif
     SITKBasicFilters_EXPORT Image Less ( double constant, const Image& image2, uint8_t backgroundValue = 0u, uint8_t foregroundValue = 1u );
  }
}
#endif
