...
*
*=========================================================================*/
#ifndef sitkBinaryDilateImageFilter_h
#define sitkBinaryDilateImageFilter_h
...
\sa itk::simple::BinaryDilate for the procedural interface
\sa itk::BinaryDilateImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT BinaryDilateImageFilter : public ImageFilter {
    public:
...
\
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("BinaryDilateImageFilter"); }
    ...
    private:
      ...
      /*  */
      bool  m_BoundaryToForeground{false};
     ...
     * \brief Fast binary dilation of a single intensity value in the image.
     *
     * This function directly calls the execute method of BinaryDilateImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::BinaryDilateImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image BinaryDilate ( const Image& image1, std::vector<unsigned int> kernelRadius = std::vector<uint32_t>(3, 1), KernelEnum kernelType = itk::simple::sitkBall, double backgroundValue = 0.0, double foregroundValue = 1.0, bool boundaryToForeground = false );
