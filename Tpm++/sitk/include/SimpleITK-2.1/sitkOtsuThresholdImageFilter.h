...
*
*=========================================================================*/
#ifndef sitkOtsuThresholdImageFilter_h
#define sitkOtsuThresholdImageFilter_h
...
\sa itk::simple::OtsuThreshold for the procedural interface
\sa itk::OtsuThresholdImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT OtsuThresholdImageFilter : public ImageFilter {
    public:
...
\
     ...
     double GetThreshold() const { return this->m_Threshold; };
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("OtsuThresholdImageFilter"); }
     ...
     * \brief Threshold an image using the Otsu Threshold.
     *
     * This function directly calls the execute method of OtsuThresholdImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::OtsuThresholdImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image OtsuThreshold ( const Image & image, const Image & maskImage, uint8_t insideValue = 1u, uint8_t outsideValue = 0u, uint32_t numberOfHistogramBins = 128u, bool maskOutput = true, uint8_t maskValue = 255u, bool returnBinMidpoint = false );
     SITKBasicFilters_EXPORT Image OtsuThreshold ( const Image & image, uint8_t insideValue = 1u, uint8_t outsideValue = 0u, uint32_t numberOfHistogramBins = 128u, bool maskOutput = true, uint8_t maskValue = 255u, bool returnBinMidpoint = false );
     /** @} */
  }
}
#endif
