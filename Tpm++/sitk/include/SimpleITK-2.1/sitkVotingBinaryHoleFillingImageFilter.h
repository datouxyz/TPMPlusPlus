...
\sa itk::VotingBinaryHoleFillingImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT VotingBinaryHoleFillingImageFilter : public ImageFilter {
    public:
...
\
     ...
     */
     ...
     SITKBasicFilters_EXPORT Image VotingBinaryHoleFilling ( const Image& image1, std::vector<unsigned int> radius = std::vector<unsigned int>(3, 1), unsigned int majorityThreshold = 1u, double foregroundValue = 1.0, double backgroundValue = 0.0 );
