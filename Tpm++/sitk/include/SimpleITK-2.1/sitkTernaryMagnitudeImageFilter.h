...
\sa itk::TernaryMagnitudeImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT TernaryMagnitudeImageFilter : public ImageFilter {
    public:
     ...
     */
#ifndef SWIG
     SITKBasicFilters_EXPORT Image TernaryMagnitude ( Image&& image1, const Image& image2, const Image& image3 );
#endif
