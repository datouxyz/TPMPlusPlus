...
*
*=========================================================================*/
#ifndef sitkGrayscaleGrindPeakImageFilter_h
#define sitkGrayscaleGrindPeakImageFilter_h
...
\sa itk::simple::GrayscaleGrindPeak for the procedural interface
\sa itk::GrayscaleGrindPeakImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT GrayscaleGrindPeakImageFilter : public ImageFilter {
    public:
      using Self = GrayscaleGrindPeakImageFilter;

      /** Destructor */
      virtual ~GrayscaleGrindPeakImageFilter();
...
\
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("GrayscaleGrindPeakImageFilter"); }
     ...
     * \brief Remove local maxima not connected to the boundary of the image.
     *
     * This function directly calls the execute method of GrayscaleGrindPeakImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::GrayscaleGrindPeakImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image GrayscaleGrindPeak ( const Image& image1, bool fullyConnected = false );
