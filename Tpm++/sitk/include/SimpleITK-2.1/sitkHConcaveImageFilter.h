...
*
*=========================================================================*/
#ifndef sitkHConcaveImageFilter_h
#define sitkHConcaveImageFilter_h
...
\sa itk::simple::HConcave for the procedural interface
\sa itk::HConcaveImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT HConcaveImageFilter : public ImageFilter {
    public:
...
\
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("HConcaveImageFilter"); }
     ...
     * \brief Identify local minima whose depth below the baseline is greater than h.
     *
     * This function directly calls the execute method of HConcaveImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::HConcaveImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image HConcave ( const Image& image1, double height = 2.0, bool fullyConnected = false );
