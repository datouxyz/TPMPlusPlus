...
*
*=========================================================================*/
#ifndef sitkBinaryMagnitudeImageFilter_h
#define sitkBinaryMagnitudeImageFilter_h
...
\sa itk::simple::BinaryMagnitude for the procedural interface
\sa itk::BinaryMagnitudeImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT BinaryMagnitudeImageFilter : public ImageFilter {
    public:
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("BinaryMagnitudeImageFilter"); }
     ...
     * \brief Computes the square root of the sum of squares of corresponding input pixels.
     *
     * This function directly calls the execute method of BinaryMagnitudeImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::BinaryMagnitudeImageFilter for the object oriented interface
     * @{
     */
#ifndef SWIG
     SITKBasicFilters_EXPORT Image BinaryMagnitude ( Image&& image1, const Image& image2 );
#endif
     SITKBasicFilters_EXPORT Image BinaryMagnitude ( const Image& image1, const Image& image2 );
