...
*
*=========================================================================*/
#ifndef sitkMeanImageFilter_h
#define sitkMeanImageFilter_h
...
\sa itk::simple::Mean for the procedural interface
\sa itk::MeanImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT MeanImageFilter : public ImageFilter {
    public:
...
\
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("MeanImageFilter"); }
     ...
     * \brief Applies an averaging filter to an image.
     *
     * This function directly calls the execute method of MeanImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::MeanImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image Mean ( const Image& image1, std::vector<unsigned int> radius = std::vector<unsigned int>(3, 1) );
