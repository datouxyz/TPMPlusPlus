...
*
*=========================================================================*/
#ifndef sitkGrayscaleMorphologicalClosingImageFilter_h
#define sitkGrayscaleMorphologicalClosingImageFilter_h
...
\sa itk::simple::GrayscaleMorphologicalClosing for the procedural interface
\sa itk::GrayscaleMorphologicalClosingImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT GrayscaleMorphologicalClosingImageFilter : public ImageFilter {
    public:
      using Self = GrayscaleMorphologicalClosingImageFilter;

      /** Destructor */
      virtual ~GrayscaleMorphologicalClosingImageFilter();
...
\
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("GrayscaleMorphologicalClosingImageFilter"); }
     ...
     * \brief gray scale dilation of an image
     *
     * This function directly calls the execute method of GrayscaleMorphologicalClosingImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::GrayscaleMorphologicalClosingImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image GrayscaleMorphologicalClosing ( const Image& image1, std::vector<unsigned int> kernelRadius = std::vector<uint32_t>(3, 1), KernelEnum kernelType = itk::simple::sitkBall, bool safeBorder = true );
