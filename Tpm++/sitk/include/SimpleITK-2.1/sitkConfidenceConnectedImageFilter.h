...
*
*=========================================================================*/
#ifndef sitkConfidenceConnectedImageFilter_h
#define sitkConfidenceConnectedImageFilter_h
...
\sa itk::simple::ConfidenceConnected for the procedural interface
\sa itk::ConfidenceConnectedImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT ConfidenceConnectedImageFilter : public ImageFilter {
    public:
...
\
     ...
     double GetVariance() const { return this->m_Variance; };
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("ConfidenceConnectedImageFilter"); }
     ...
     * \brief Segment pixels with similar statistics using connectivity.
     *
     * This function directly calls the execute method of ConfidenceConnectedImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::ConfidenceConnectedImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image ConfidenceConnected ( const Image& image1, std::vector< std::vector<unsigned int> > seedList = std::vector< std::vector<unsigned int > >(), unsigned int numberOfIterations = 4u, double multiplier = 4.5, unsigned int initialNeighborhoodRadius = 1u, uint8_t replaceValue = 1u );
