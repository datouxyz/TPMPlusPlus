...
*
*=========================================================================*/
#ifndef sitkBinaryClosingByReconstructionImageFilter_h
#define sitkBinaryClosingByReconstructionImageFilter_h
...
\sa itk::simple::BinaryClosingByReconstruction for the procedural interface
\sa itk::BinaryClosingByReconstructionImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT BinaryClosingByReconstructionImageFilter : public ImageFilter {
    public:
...
\
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("BinaryClosingByReconstructionImageFilter"); }
     ...
     *
     * \sa itk::simple::BinaryClosingByReconstructionImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image BinaryClosingByReconstruction ( const Image& image1, std::vector<unsigned int> kernelRadius = std::vector<uint32_t>(3, 1), KernelEnum kernelType = itk::simple::sitkBall, double foregroundValue = 1.0, bool fullyConnected = false );
