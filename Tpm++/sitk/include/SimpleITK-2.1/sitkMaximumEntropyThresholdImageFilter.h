...
*
*=========================================================================*/
#ifndef sitkMaximumEntropyThresholdImageFilter_h
#define sitkMaximumEntropyThresholdImageFilter_h
...
This filter creates a binary thresholded image that separates an image into foreground and background components. The filter computes the threshold using the MaximumEntropyThresholdCalculator and applies that threshold to the input image using the BinaryThresholdImageFilter .
...
\sa itk::simple::MaximumEntropyThreshold for the procedural interface
\sa itk::MaximumEntropyThresholdImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT MaximumEntropyThresholdImageFilter : public ImageFilter {
    public:
      using Self = MaximumEntropyThresholdImageFilter;

      /** Destructor */
      virtual ~MaximumEntropyThresholdImageFilter();
...
\
     ...
     double GetThreshold() const { return this->m_Threshold; };
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("MaximumEntropyThresholdImageFilter"); }
     ...
     * \brief Threshold an image using the MaximumEntropy Threshold.
     *
     * This function directly calls the execute method of MaximumEntropyThresholdImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::MaximumEntropyThresholdImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image MaximumEntropyThreshold ( const Image & image, const Image & maskImage, uint8_t insideValue = 1u, uint8_t outsideValue = 0u, uint32_t numberOfHistogramBins = 256u, bool maskOutput = true, uint8_t maskValue = 255u );
     SITKBasicFilters_EXPORT Image MaximumEntropyThreshold ( const Image & image, uint8_t insideValue = 1u, uint8_t outsideValue = 0u, uint32_t numberOfHistogramBins = 256u, bool maskOutput = true, uint8_t maskValue = 255u );
     /** @} */
  }
}
#endif
