...
*
*=========================================================================*/
#ifndef sitkDivideRealImageFilter_h
#define sitkDivideRealImageFilter_h
...
\sa itk::simple::DivideReal for the procedural interface
\sa itk::BinaryFunctorImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT DivideRealImageFilter : public ImageFilter {
    public:
      using Self = DivideRealImageFilter;

      /** Destructor */
      virtual ~DivideRealImageFilter();
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("DivideRealImageFilter"); }
     ...
     * \brief Implements pixel-wise generic operation of two images, or of an image and a constant.
     *
     * This function directly calls the execute method of DivideRealImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::DivideRealImageFilter for the object oriented interface
     * @{
     */
#ifndef SWIG
     SITKBasicFilters_EXPORT Image DivideReal ( Image&& image1, const Image& image2 );
#endif
     SITKBasicFilters_EXPORT Image DivideReal ( const Image& image1, const Image& image2 );

     /** @} */
     SITKBasicFilters_EXPORT Image DivideReal ( const Image& image1, double constant );
#ifndef  SWIG
     SITKBasicFilters_EXPORT Image DivideReal ( Image&& image1, double constant );
#endif
     SITKBasicFilters_EXPORT Image DivideReal ( double constant, const Image& image2 );
  }
}
#endif
