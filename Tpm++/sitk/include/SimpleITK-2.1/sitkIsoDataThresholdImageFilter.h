...
*
*=========================================================================*/
#ifndef sitkIsoDataThresholdImageFilter_h
#define sitkIsoDataThresholdImageFilter_h
...
This filter creates a binary thresholded image that separates an image into foreground and background components. The filter computes the threshold using the IsoDataThresholdCalculator and applies that threshold to the input image using the BinaryThresholdImageFilter .
...
\sa itk::simple::IsoDataThreshold for the procedural interface
\sa itk::IsoDataThresholdImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT IsoDataThresholdImageFilter : public ImageFilter {
    public:
      using Self = IsoDataThresholdImageFilter;

      /** Destructor */
      virtual ~IsoDataThresholdImageFilter();
...
\
     ...
     double GetThreshold() const { return this->m_Threshold; };
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("IsoDataThresholdImageFilter"); }
     ...
     * \brief Threshold an image using the IsoData Threshold.
     *
     * This function directly calls the execute method of IsoDataThresholdImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::IsoDataThresholdImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image IsoDataThreshold ( const Image & image, const Image & maskImage, uint8_t insideValue = 1u, uint8_t outsideValue = 0u, uint32_t numberOfHistogramBins = 256u, bool maskOutput = true, uint8_t maskValue = 255u );
     SITKBasicFilters_EXPORT Image IsoDataThreshold ( const Image & image, uint8_t insideValue = 1u, uint8_t outsideValue = 0u, uint32_t numberOfHistogramBins = 256u, bool maskOutput = true, uint8_t maskValue = 255u );
     /** @} */
  }
}
#endif
