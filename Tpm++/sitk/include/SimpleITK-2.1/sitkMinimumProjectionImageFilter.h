...
*
*=========================================================================*/
#ifndef sitkMinimumProjectionImageFilter_h
#define sitkMinimumProjectionImageFilter_h
...
\sa itk::simple::MinimumProjection for the procedural interface
\sa itk::MinimumProjectionImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT MinimumProjectionImageFilter : public ImageFilter {
    public:
...
\
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("MinimumProjectionImageFilter"); }
     ...
     * \brief Minimum projection.
     *
     * This function directly calls the execute method of MinimumProjectionImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::MinimumProjectionImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image MinimumProjection ( const Image& image1, unsigned int projectionDimension = 0u );
