...
*
*=========================================================================*/
#ifndef sitkBoxMeanImageFilter_h
#define sitkBoxMeanImageFilter_h
...
\sa itk::simple::BoxMean for the procedural interface
\sa itk::BoxMeanImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT BoxMeanImageFilter : public ImageFilter {
    public:
      using Self = BoxMeanImageFilter;

      /** Destructor */
      virtual ~BoxMeanImageFilter();
...
\
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("BoxMeanImageFilter"); }
     ...
     * \brief Implements a fast rectangular mean filter using the accumulator approach.
     *
     * This function directly calls the execute method of BoxMeanImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::BoxMeanImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image BoxMean ( const Image& image1, std::vector<unsigned int> radius = std::vector<unsigned int>(3, 1) );
