...
*
*=========================================================================*/
#ifndef sitkIntermodesThresholdImageFilter_h
#define sitkIntermodesThresholdImageFilter_h
...
\sa itk::simple::IntermodesThreshold for the procedural interface
\sa itk::IntermodesThresholdImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT IntermodesThresholdImageFilter : public ImageFilter {
    public:
      using Self = IntermodesThresholdImageFilter;

      /** Destructor */
      virtual ~IntermodesThresholdImageFilter();
...
\
     ...
     double GetThreshold() const { return this->m_Threshold; };
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("IntermodesThresholdImageFilter"); }
     ...
     * \brief Threshold an image using the Intermodes Threshold.
     *
     * This function directly calls the execute method of IntermodesThresholdImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::IntermodesThresholdImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image IntermodesThreshold ( const Image & image, const Image & maskImage, uint8_t insideValue = 1u, uint8_t outsideValue = 0u, uint32_t numberOfHistogramBins = 256u, bool maskOutput = true, uint8_t maskValue = 255u );
     SITKBasicFilters_EXPORT Image IntermodesThreshold ( const Image & image, uint8_t insideValue = 1u, uint8_t outsideValue = 0u, uint32_t numberOfHistogramBins = 256u, bool maskOutput = true, uint8_t maskValue = 255u );
     /** @} */
  }
}
#endif
