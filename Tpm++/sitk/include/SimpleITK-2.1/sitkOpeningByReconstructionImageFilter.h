...
*
*=========================================================================*/
#ifndef sitkOpeningByReconstructionImageFilter_h
#define sitkOpeningByReconstructionImageFilter_h
...
\sa itk::simple::OpeningByReconstruction for the procedural interface
\sa itk::OpeningByReconstructionImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT OpeningByReconstructionImageFilter : public ImageFilter {
    public:
      using Self = OpeningByReconstructionImageFilter;

      /** Destructor */
      virtual ~OpeningByReconstructionImageFilter();
...
\
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("OpeningByReconstructionImageFilter"); }
     ...
     * \brief Opening by reconstruction of an image.
     *
     * This function directly calls the execute method of OpeningByReconstructionImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::OpeningByReconstructionImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image OpeningByReconstruction ( const Image& image1, std::vector<unsigned int> kernelRadius = std::vector<uint32_t>(3, 1), KernelEnum kernelType = itk::simple::sitkBall, bool fullyConnected = false, bool preserveIntensities = false );
