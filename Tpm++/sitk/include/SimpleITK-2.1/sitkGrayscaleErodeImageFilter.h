...
\sa itk::GrayscaleErodeImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT GrayscaleErodeImageFilter : public ImageFilter {
    public:
...
\
     ...
     *
     * \sa itk::simple::GrayscaleErodeImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image GrayscaleErode ( const Image& image1, std::vector<unsigned int> kernelRadius = std::vector<uint32_t>(3, 1), KernelEnum kernelType = itk::simple::sitkBall );
