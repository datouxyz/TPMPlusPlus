...
*
*=========================================================================*/
#ifndef sitkMinimumImageFilter_h
#define sitkMinimumImageFilter_h
...
\sa itk::simple::Minimum for the procedural interface
\sa itk::MinimumImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT MinimumImageFilter : public ImageFilter {
    public:
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("MinimumImageFilter"); }
     ...
     * \brief Implements a pixel-wise operator Min(a,b) between two images.
     *
     * This function directly calls the execute method of MinimumImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::MinimumImageFilter for the object oriented interface
     * @{
     */
#ifndef SWIG
     SITKBasicFilters_EXPORT Image Minimum ( Image&& image1, const Image& image2 );
#endif
     SITKBasicFilters_EXPORT Image Minimum ( const Image& image1, const Image& image2 );

     /** @} */
     SITKBasicFilters_EXPORT Image Minimum ( const Image& image1, double constant );
#ifndef  SWIG
     SITKBasicFilters_EXPORT Image Minimum ( Image&& image1, double constant );
#endif
     SITKBasicFilters_EXPORT Image Minimum ( double constant, const Image& image2 );
  }
}
#endif
