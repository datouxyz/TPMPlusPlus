...
*
*=========================================================================*/
#ifndef sitkLiThresholdImageFilter_h
#define sitkLiThresholdImageFilter_h
...
\sa itk::simple::LiThreshold for the procedural interface
\sa itk::LiThresholdImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT LiThresholdImageFilter : public ImageFilter {
    public:
...
\
     ...
     double GetThreshold() const { return this->m_Threshold; };
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("LiThresholdImageFilter"); }
     ...
     * \brief Threshold an image using the Li Threshold.
     *
     * This function directly calls the execute method of LiThresholdImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::LiThresholdImageFilter for the object oriented interface
     * @{
     */

     SITKBasicFilters_EXPORT Image LiThreshold ( const Image & image, const Image & maskImage, uint8_t insideValue = 1u, uint8_t outsideValue = 0u, uint32_t numberOfHistogramBins = 256u, bool maskOutput = true, uint8_t maskValue = 255u );
     SITKBasicFilters_EXPORT Image LiThreshold ( const Image & image, uint8_t insideValue = 1u, uint8_t outsideValue = 0u, uint32_t numberOfHistogramBins = 256u, bool maskOutput = true, uint8_t maskValue = 255u );
     /** @} */
  }
}
#endif
