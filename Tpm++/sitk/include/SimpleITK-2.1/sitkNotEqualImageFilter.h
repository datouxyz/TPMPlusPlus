...
*
*=========================================================================*/
#ifndef sitkNotEqualImageFilter_h
#define sitkNotEqualImageFilter_h
...
\sa itk::simple::NotEqual for the procedural interface
\sa itk::BinaryFunctorImageFilter for the Doxygen on the original ITK class.
     */
    class SITKBasicFilters_EXPORT NotEqualImageFilter : public ImageFilter {
    public:
      using Self = NotEqualImageFilter;
...
\
      ...
      /** Name of this class */
      std::string GetName() const { return std::string ("NotEqualImageFilter"); }
     ...
     * \brief Implements pixel-wise generic operation of two images, or of an image and a constant.
     *
     * This function directly calls the execute method of NotEqualImageFilter
     * in order to support a procedural API
     *
     * \sa itk::simple::NotEqualImageFilter for the object oriented interface
     * @{
     */
#ifndef SWIG
     SITKBasicFilters_EXPORT Image NotEqual ( Image&& image1, const Image& image2, uint8_t backgroundValue = 0u, uint8_t foregroundValue = 1u );
#endif
     SITKBasicFilters_EXPORT Image NotEqual ( const Image& image1, const Image& image2, uint8_t backgroundValue = 0u, uint8_t foregroundValue = 1u );

     /** @} */
     SITKBasicFilters_EXPORT Image NotEqual ( const Image& image1, double constant, uint8_t backgroundValue = 0u, uint8_t foregroundValue = 1u );
#ifndef  SWIG
     SITKBasicFilters_EXPORT Image NotEqual ( Image&& image1, double constant, uint8_t backgroundValue = 0u, uint8_t foregroundValue = 1u );
#endif
     SITKBasicFilters_EXPORT Image NotEqual ( double constant, const Image& image2, uint8_t backgroundValue = 0u, uint8_t foregroundValue = 1u );
  }
}
#endif
